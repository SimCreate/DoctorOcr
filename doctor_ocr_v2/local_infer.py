#!/usr/bin/env python3
"""
Doctor Handwriting OCR - Local Inference Script (v2)
...
# Default to GPU 0 (RTX PRO 6000 Blackwell Workstation Edition) — cuda0 workstation
...
# Blackwell enforced: CUDA_VISIBLE_DEVICES='0' → cuda:0 = GPU 0 (RTX PRO 6000)
...
def load_model_and_dict():
    ...
    # Handle DataParallel checkpoint (keys have 'module.' prefix) - for backward compatibility
